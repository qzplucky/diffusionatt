...
def create_argparser():
    defaults = dict(
        data_dir="/home/py_/dataset/celeba_hq_256/",
        output_dir="ffhq256_deca.lmdb",
        image_size=256,
        batch_size=8,
        use_meanshape=False,
    )
...
# python scripts/create_data.py --data_dir /home/py_/dataset/celeba_hq_256/ --output_dir ffhq256_deca.lmdb --image_size 256 --use_meanshape False
